...
// wflscoin includes.
#include <..\src\script\wflscoinconsensus.h>
...
int main()
{
    std::cout << "wflscoinconsensus version: " << wflscoinconsensus_version() << std::endl;
    ...
    auto op0Result = wflscoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, wflscoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
