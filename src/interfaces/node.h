...
#ifndef WFLSCOIN_INTERFACES_NODE_H
#define WFLSCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a wflscoin node (wflscoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // WFLSCOIN_INTERFACES_NODE_H
