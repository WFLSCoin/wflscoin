...
#ifndef WFLSCOIN_INTERFACES_INIT_H
#define WFLSCOIN_INTERFACES_INIT_H
...
//! (wflscoin-gui, wflscoin-node, wflscoin-wallet, wflscoind, wflscoin-qt) and each
...
#endif // WFLSCOIN_INTERFACES_INIT_H
