...
#ifndef WFLSCOIN_INTERFACES_CHAIN_H
#define WFLSCOIN_INTERFACES_CHAIN_H
...
//! internal workings of the wflscoin node, and not being very convenient to use.
//! Chain methods should be cleaned up and simplified over time. Examples:
//!
//! * The initMessages() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/wflscoin/wflscoin/pull/15288#discussion_r253321096).
//!
...
//!   node (https://github.com/wflscoin/wflscoin/issues/11756)
class Chain
{
public:
    virtual ~Chain() {}
...
#endif // WFLSCOIN_INTERFACES_CHAIN_H
