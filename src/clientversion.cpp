 ...
 * for both wflscoind and wflscoin-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/wflscoin/bips/blob/master/bip-0014.mediawiki)
 */
