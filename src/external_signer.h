// Copyright (c) 2018-2021 The Wflscoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef WFLSCOIN_EXTERNAL_SIGNER_H
#define WFLSCOIN_EXTERNAL_SIGNER_H
...
#endif // WFLSCOIN_EXTERNAL_SIGNER_H
