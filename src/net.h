...
#ifndef WFLSCOIN_NET_H
#define WFLSCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/wflscoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Wflscoin’s Peer-to-Peer Network")
