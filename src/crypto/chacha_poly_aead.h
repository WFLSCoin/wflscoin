...
#ifndef WFLSCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define WFLSCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@wflscoin.
 *
 ...
 *
 * The chacha20-poly1305@wflscoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@wflscoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@wflscoin are relatively fast in
...
#endif // WFLSCOIN_CRYPTO_CHACHA_POLY_AEAD_H
