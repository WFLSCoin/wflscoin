...
#ifndef WFLSCOIN_SCRIPT_STANDARD_H
#define WFLSCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a wflscoin address
 */
...
/**
 * Generate a Wflscoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // WFLSCOIN_SCRIPT_STANDARD_H
