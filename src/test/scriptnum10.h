...
#ifndef WFLSCOIN_TEST_SCRIPTNUM10_H
#define WFLSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Wflscoin Core 0.10.0, for cross-comparison.
 */
public:
