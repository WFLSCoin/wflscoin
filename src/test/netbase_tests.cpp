...
{
    BOOST_CHECK(TestSplitHost("www.wflscoincore.org", "www.wflscoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.wflscoincore.org]", "www.wflscoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.wflscoincore.org:80", "www.wflscoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.wflscoincore.org]:80", "www.wflscoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9357", "127.0.0.1", 9357));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9357", "127.0.0.1", 9357));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9357", "::ffff:127.0.0.1", 9357));
    BOOST_CHECK(TestSplitHost("[::]:9357", "::", 9357));
    BOOST_CHECK(TestSplitHost("::9357", "::9357", 0));
    BOOST_CHECK(TestSplitHost(":9357", "", 9357));
    BOOST_CHECK(TestSplitHost("[]:9357", "", 9357));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9357", "127.0.0.1:9357"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9357", "[::]:9357"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
