    ...
    mapper(nullptr)
{
    ...
    ui->wflscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->wflscoinAtStartup);
    ...
    ui->wflscoinAtStartup->setToolTip(ui->wflscoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->wflscoinAtStartup->setText(ui->wflscoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openWflscoinConfButton->setToolTip(ui->openWflscoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new WflscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->wflscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openWflscoinConfButton_clicked()
{
