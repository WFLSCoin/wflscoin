...
#ifndef WFLSCOIN_QT_GUIUTIL_H
#define WFLSCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Wflscoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "wflscoin:" URI into recipient object, return true on successful parsing
