...
//! Entry point for WflscoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &WflscoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for WflscoinGUI tests.
void AppTests::guiTests(WflscoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &WflscoinGUI::consoleShown, this, &AppTests::consoleTests);
