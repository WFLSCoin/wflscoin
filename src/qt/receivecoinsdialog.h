...
#ifndef WFLSCOIN_QT_RECEIVECOINSDIALOG_H
#define WFLSCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of wflscoins */
...
#endif // WFLSCOIN_QT_RECEIVECOINSDIALOG_H
