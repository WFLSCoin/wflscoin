    ...
    platformStyle(_platformStyle)
{
    ...
    // normal wflscoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying wflscoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &WflscoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
