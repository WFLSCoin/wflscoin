...
#ifndef WFLSCOIN_QT_WFLSCOINGUI_H
#define WFLSCOIN_QT_WFLSCOINGUI_H
...
/**
  Wflscoin GUI main class. This class represents the main window of the Wflscoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class WflscoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit WflscoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~WflscoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a wflscoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Wflscoin Transaction from file or clipboard */
...
#endif // WFLSCOIN_QT_WFLSCOINGUI_H
