...
#ifndef WFLSCOIN_COMPAT_ASSUMPTIONS_H
#define WFLSCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Wflscoin cannot be compiled without assertions."
#endif
...
#endif // WFLSCOIN_COMPAT_ASSUMPTIONS_H
