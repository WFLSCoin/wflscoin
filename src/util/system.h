 ...
 */
#ifndef WFLSCOIN_UTIL_SYSTEM_H
#define WFLSCOIN_UTIL_SYSTEM_H
...
extern const char * const WFLSCOIN_CONF_FILENAME;
extern const char * const WFLSCOIN_SETTINGS_FILENAME;
