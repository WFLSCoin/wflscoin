...
#ifndef WFLSCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define WFLSCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Wflscoin Core wallet was originally a collection of unrelated private
...
#endif // WFLSCOIN_WALLET_SCRIPTPUBKEYMAN_H
