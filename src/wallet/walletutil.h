...
#ifndef WFLSCOIN_WALLET_WALLETUTIL_H
#define WFLSCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! wflscoin from opening the wallet, thinking it was newly created, and
...
#endif // WFLSCOIN_WALLET_WALLETUTIL_H
