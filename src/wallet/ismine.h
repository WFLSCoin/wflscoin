...
#ifndef WFLSCOIN_WALLET_ISMINE_H
#define WFLSCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/wflscoin/wflscoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // WFLSCOIN_WALLET_ISMINE_H
