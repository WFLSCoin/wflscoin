...
#ifndef WFLSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define WFLSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // WFLSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
