...
#ifndef WFLSCOIN_PROTOCOL_H
#define WFLSCOIN_PROTOCOL_H
...
/**
 * Wflscoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Wflscoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Wflscoin Core nodes used to support this by default, without advertising this bit,
    ...
    // wflscoin-development mailing list. Remember that service bits are just
