Wflscoin Core version 0.10.4 is now available from:

  <https://wflscoin.org/bin/wflscoin-core-0.10.4/>
...
- #6953 `43c2789` Split wflscoin-tx into its own package
- #6953 `dfe0d4d` Include wflscoin-tx binary on Debian/Ubuntu
