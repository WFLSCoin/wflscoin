Wflscoin Core version 0.16.1 is now available from:

  <https://wflscoincore.org/bin/wflscoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting wflscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure wflscoind processes are cleaned up when tests end (sdaftuar)
