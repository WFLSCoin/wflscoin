Wflscoin Core version *0.14.3* is now available from:

  <https://wflscoin.org/bin/wflscoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/wflscoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
