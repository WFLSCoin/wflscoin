Wflscoin Core version 0.9.2.1 is now available from:

  https://wflscoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 WFLS to 0.01 WFLS
...
- Fix "Start wflscoin on system login"
