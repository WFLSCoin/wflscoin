Download URL: https://sourceforge.net/projects/wflscoin/files/Wflscoin/wflscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 WFLS fee schedule (users still pay 0.01 WFLS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #wflscoin00 - #wflscoin99
