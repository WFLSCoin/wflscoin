...
Wflscoin Core version 0.19.1 is now available from:

  <https://wflscoincore.org/bin/wflscoin-core-0.19.1/>
...
From Wflscoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Wflscoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Wflscoin Core does not yet change appearance when
...
- #17488 fix "wflscoind already running" warnings on macOS (fanquake)
