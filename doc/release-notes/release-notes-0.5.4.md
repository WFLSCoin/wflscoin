Wflscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/wflscoin/files/Wflscoin/wflscoin-0.5.4/
...
http://gitorious.org/wflscoin/wflscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Wflscoin-Qt notifications under Growl 1.3.
Increase required age of Wflscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxWflscoin properly when installing Wflscoin-Qt over it. (Windows)
