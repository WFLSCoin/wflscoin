Wflscoin Core version 0.9.4 is now available from:

  https://wflscoin.org/bin/0.9.4/
...
this update is incompatible with the Wflscoin system and could lead to consensus
forks.

Wflscoin Core released binaries from https://wflscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~wflscoin/+archive/ubuntu/wflscoin
- A third-party or self-compiled Wflscoin Core

upgrade to Wflscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
