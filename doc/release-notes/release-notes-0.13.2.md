Wflscoin Core version 0.13.2 is now available from:

  <https://wflscoin.org/bin/wflscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update wflscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow wflscoin-tx to create v2 transactions (wflsdrak)
