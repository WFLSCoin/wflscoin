Wflscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/wflscoin/files/Wflscoin/wflscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Wflscoin
...
New/changed settings (command-line or wflscoin.conf file)
--------------------------------------------------------
