...
This document provides guidelines for internationalization of the Wflscoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Wflscoin network</numerusform>
            <numerusform>%n active connections to Wflscoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wflscoin_en.ts` remains unchanged.
