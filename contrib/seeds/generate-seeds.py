...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef WFLSCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define WFLSCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the wflscoin network\n')
    ...
    g.write('#endif // WFLSCOIN_CHAINPARAMSSEEDS_H\n')
