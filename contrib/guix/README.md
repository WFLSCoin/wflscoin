# Bootstrappable Wflscoin Core Builds

This directory contains the files necessary to perform bootstrappable Wflscoin
Core builds.
...
From the top of a clean Wflscoin Core repository:
...
To use dongcarl's substitute server for Wflscoin Core builds after having
