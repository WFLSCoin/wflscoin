...
wflscoincore.org and wflscoin.org and compares them.
...
WORKINGDIR = "/tmp/wflscoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://wflscoincore.org"
HOST2 = "https://wflscoin.org"
VERSIONPREFIX = "wflscoin-core-"
...
def main(args):
    ...
    if not success:
        print("wflscoin.org failed to provide signature file, "
              "but wflscoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("wflscoin.org and wflscoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Wflscoin Core binary release "
