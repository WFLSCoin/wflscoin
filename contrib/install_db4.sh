...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the wflscoin repository."
  exit 1
fi
...
# See https://github.com/wflscoin/wflscoin/issues/16064
...
echo 'When compiling wflscoind, run `./configure` in the following way:'
echo
