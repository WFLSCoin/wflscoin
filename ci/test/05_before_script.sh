...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Wflscoin
else
  DOCKER_EXEC echo \> \$HOME/.wflscoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/wflscoin/wflscoin/pull/18288#discussion_r433189350 for
  # details.
