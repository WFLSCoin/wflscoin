...
By default, wflscoind will dump mempool on shutdown and
...
class MempoolPersistTest(WflscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent wflscoind from writing mempool.dat to disk. Verify that `savemempool` fails")
