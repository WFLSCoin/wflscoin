...
class P2PPermissionsTests(WflscoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].wflscoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].wflscoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
