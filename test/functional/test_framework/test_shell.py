...
class TestShell:
    """Wrapper Class for WflscoinTestFramework.

    The TestShell class extends the WflscoinTestFramework
    ...
    class __TestShell(WflscoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by WflscoinTestFramework child class.
            self.num_nodes = 1
