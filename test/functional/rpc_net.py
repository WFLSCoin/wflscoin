...
class NetTest(WflscoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 9357)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(addrs[0]["port"], 9357)
