...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WflscoinTestFramework
    pass


class ExampleTest(WflscoinTestFramework):
    # Each functional test is a subclass of the WflscoinTestFramework class.
    ...
    def custom_method(self):
        ...
        WflscoinTestFramework class so other tests can use it."""
