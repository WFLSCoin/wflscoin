#!/usr/bin/env python3
# Copyright (c) 2017-2018 The Wflscoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test external signer.

Verify that a wflscoind node can use an external signer command.
...
class RPCSignerTest(WflscoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart wflscoind with -signer=<cmd>',
